  ...
  export default {
    ...
    methods: {
      ...
      loop() {
        ...
        const coinsCollected = this.highway.checkCoinCollections(this.ui.car.position, this.carCoinRadius);
        if (coinsCollected > 0) {
          this.audioManager.play('coin');
          this.coins += coinsCollected;
          
          // Add bonus score for coins
          this.score += coinsCollected * 5 * this.scoreMultiplier;
